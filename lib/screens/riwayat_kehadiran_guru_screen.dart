// File: lib/screens/riwayat_kehadiran_guru_screen.dart
...
class RiwayatKehadiranGuruScreen extends StatefulWidget {
  final String nipy;

  const RiwayatKehadiranGuruScreen({super.key, required this.nipy});

  @override
  State<RiwayatKehadiranGuruScreen> createState() => _RiwayatKehadiranGuruScreenState();
}

class _RiwayatKehadiranGuruScreenState extends State<RiwayatKehadiranGuruScreen> {
  ...
  late Future<List<KehadiranGuru>> _futureRiwayatKehadiran;
  ...
  void initState() {
    ...
    _futureRiwayatKehadiran = _fetchRiwayatKehadiran();
  }

  Future<List<KehadiranGuru>> _fetchRiwayatKehadiran() {
    return _apiService.getRiwayatKehadiranGuru(
      widget.nipy,
  ...
  void _showFotoModal(BuildContext context, int idKehadiran) {
    ...
    final String fotoUrl = '${AppConstants.fotoguruBaseUrl}/$fotoFileName';
  ...
  // Tambahkan fungsi ini di dalam kelas state
      ...
      body: Container(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            FutureBuilder<List<KehadiranGuru>>(
              future: _futureRiwayatKehadiran,
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 10),
                            Text(
                              'Tidak ada riwayat kehadiran ditemukan untuk filter ini.',
                              textAlign: TextAlign.center,
                  ...
                  final int jumlahMasuk = kehadiranList.where((k) => k.status == 'MASUK').length;
                  // Hitung jumlah hari kerja (Senin-Jumat) sesuai filter
                  final int jumlahHariKerja = (_selectedYear != null && _selectedMonth != null)
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text('Jumlah hari kerja:', style: GoogleFonts.poppins(fontSize: 16, color: Colors.grey[700])),
                                    Text('$jumlahHariKerja hari', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.blueGrey[800])),
                                  ],
                                ),
                                const SizedBox(height: 10),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text('Jumlah kehadiran (MASUK):', style: GoogleFonts.poppins(fontSize: 16, color: Colors.grey[700])),
                                    Text('$jumlahMasuk hari', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.green[700])),
                                  ],
                                ),
                              ],
                            ),
